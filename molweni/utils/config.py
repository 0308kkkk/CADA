...
MRC_MODEL_LIST = ['baseline', 'our', 'drop', 'our_drop', 'our_kl']
...
parser.add_argument("--seed", type=int, default=1919810, help="random seed for initialization")
...
parser.add_argument('--discourse_layers', type=int, default=2)
parser.add_argument('--qasutr_layers', type=int, default=2)
parser.add_argument('--spk_layers', type=int, default=2)
